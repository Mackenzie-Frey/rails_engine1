...
describe "Invoice Items API - Multi Finders" do
  ...
  it 'Multi Finder - Unit_Price' do
    ...
    ii1 = create(:invoice_item, item: item1, invoice: invoice1, quantity: 100, unit_price: 2, created_at: "2012-03-13 16:54:10 UTC", updated_at: "2011-03-07 12:54:10 UTC")
    ii2 = create(:invoice_item, item: item2, invoice: invoice2, quantity: 200, unit_price: 3, created_at: "2016-03-13 16:54:10 UTC", updated_at: "2014-03-07 12:54:10 UTC")
    ii3 = create(:invoice_item, item: item3, invoice: invoice3, quantity: 200, unit_price: 3, created_at: "2017-03-13 16:54:10 UTC", updated_at: "2015-03-07 12:54:10 UTC")
  ...
  it 'Multi Finder - Created_At' do
    ...
    ii1 = create(:invoice_item, item: item1, invoice: invoice1, quantity: 100, unit_price: 2, created_at: "2012-03-13 16:54:10 UTC", updated_at: "2011-03-07 12:54:10 UTC")
    ii2 = create(:invoice_item, item: item2, invoice: invoice2, quantity: 200, unit_price: 3, created_at: "2016-03-13 16:54:10 UTC", updated_at: "2014-03-07 12:54:10 UTC")
    ii3 = create(:invoice_item, item: item3, invoice: invoice3, quantity: 200, unit_price: 4, created_at: "2016-03-13 16:54:10 UTC", updated_at: "2015-03-07 12:54:10 UTC")
...
describe 'Relationship Endpoints - Invoice Items' do
